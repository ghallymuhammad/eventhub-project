        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-4 max-w-md">
              Your complete event management platform. Discover, create, and manage amazing events with ease.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/referrals" className="text-gray-400 hover:text-white transition-colors">
                  Referral Program
                </Link>
              </li>
            </ul>
