    ...
    try {
      ...
      if (response.data?.success) {
        ...
        const transformedEvents = response.data.events.map((event: any) => ({
          ...
          price: event.isFree ? 'Free' : formatIDR(event.minPrice || event.price || 0),
          priceValue: event.isFree ? 0 : (event.minPrice || event.price || 0),
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6 drop-shadow-lg">
              Got Weekend Plans?
              <span className="text-yellow-300 block">We&apos;ve Got You Covered! 🎉</span>
            </h1>
            <p className="text-xl text-white/90 mb-8 max-w-3xl mx-auto drop-shadow-md">
              Ready for your next adventure? Whether you&apos;re craving live music, learning something new, or just want to have fun - discover thousands of amazing events happening right around you!
            </p>
          </div>
