...
export const api = {
  ...
  user: {
    ...
    getTickets: (params?: any) => axiosInstance.get("/user/tickets", { params }),
    getPointHistory: (params?: any) => axiosInstance.get("/user/points", { params }),
    getCoupons: () => axiosInstance.get("/user/coupons"),
    updateProfile: (data: any) => axiosInstance.put("/user/profile", data),
  },

  // Checkout endpoints
  checkout: {
    getPreview: (data: any) => axiosInstance.post("/checkout/preview", data),
    createTransaction: (data: any) => axiosInstance.post("/checkout/create", data),
    uploadPayment: (transactionId: string, data: any) =>
      axiosInstance.put(`/checkout/${transactionId}/payment`, data),
  },
