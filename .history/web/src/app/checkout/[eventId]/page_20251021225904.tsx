...
import { us      const response = await apiService.createTransaction(transactionData);
      ...
      if (response.data?.success) {
        ...
        throw new Error(response.data?.message || 'Failed to create transaction');from '@/contexts/AuthContext';
import { 
  ShoppingCart,
