        ...
        if (userData && userToken) {
          try {
            ...
            if (user.role === 'ORGANIZER') {
              router.push('/organizer/dashboard?verified=true'); // Organizer dashboard
            } else if (user.role === 'ADMIN') {
              router.push('/admin?verified=true'); // Admin dashboard
            } else {
              router.push('/?verified=true'); // Regular user to homepage
            }
          } catch (error) {
