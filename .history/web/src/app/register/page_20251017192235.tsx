...
function RegisterContent() {
  ...
  const handleSubmit = async (values: RegisterFormData, formikBag: any) => {
    ...
    try {
      ...
      const response = await api.users.register(registrationData);
      ...
      if (typeof window !== 'undefined') {
        ...
        console.log('💾 Stored auth data:', { token: !!token, user: !!user });
      }
      ...
      if (error.response?.status === 400) {
        ...
        if (errorData.message && errorData.message.includes('Email already registered')) {
          ...
          alert(errorData.message || 'Registration failed. Please check your information.');
        }
...
export default function RegisterPage() {
  return (
    <Suspense fallback={
      <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-black flex items-center justify-center pt-8">
        <div className="glassmorphism rounded-3xl p-8 backdrop-blur-xl bg-white/10 border border-white/20">
          <div className="flex items-center justify-center">
