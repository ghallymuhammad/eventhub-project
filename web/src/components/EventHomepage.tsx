      ...
      <section className="relative overflow-hidden py-16 lg:py-24 pt-24 lg:pt-32">{/* Added pt-24 for navbar spacing */}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative">
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 rounded-2xl blur-xl opacity-30 animate-pulse"></div>
            
            <div className="relative bg-white/90 backdrop-blur-md rounded-2xl shadow-2xl border border-white/40 p-6 mb-8 max-w-6xl mx-auto">
              ...
              <div className="relative mb-6">
                ...
                <input
                  ...
                  className="relative w-full px-6 py-4 pl-14 text-lg bg-white/70 backdrop-blur-sm border-2 border-white/50 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:bg-white/90 transition-all duration-300 shadow-lg placeholder:text-gray-400"
                />
              ...
              {/* Filter Categories with glassmorphism */}
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-full text-sm font-medium transition-all duration-200 backdrop-blur-sm ${
                      selectedCategory === category
                        ? 'bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-lg transform scale-105 border border-white/20'
                        : 'bg-white/60 text-gray-700 hover:bg-white/80 border border-white/40 hover:shadow-md'
                    }`}
                  >
              ...
              {/* Location and Sort Filters with glassmorphism */}
              <div className="flex flex-col sm:flex-row gap-4">
                <div className="flex-1">
                  <select
                    value={selectedLocation}
                    onChange={(e) => setSelectedLocation(e.target.value)}
                    className="w-full px-4 py-3 bg-white/70 backdrop-blur-sm border-2 border-white/50 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:bg-white/90 transition-all duration-300 shadow-md"
                  >
